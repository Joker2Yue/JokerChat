package com.joker2yue.chat.common.chat.service.impl;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.lang.Pair;
import com.joker2yue.chat.common.chat.dao.ContactDao;
import com.joker2yue.chat.common.chat.dao.GroupMemberDao;
import com.joker2yue.chat.common.chat.dao.MessageDao;
import com.joker2yue.chat.common.chat.domain.dto.RoomBaseInfo;
import com.joker2yue.chat.common.chat.domain.entity.*;
import com.joker2yue.chat.common.chat.domain.enums.GroupRoleAPPEnum;
import com.joker2yue.chat.common.chat.domain.enums.GroupRoleEnum;
import com.joker2yue.chat.common.chat.domain.enums.HotFlagEnum;
import com.joker2yue.chat.common.chat.domain.enums.RoomTypeEnum;
import com.joker2yue.chat.common.chat.domain.vo.request.ChatMessageMemberReq;
import com.joker2yue.chat.common.chat.domain.vo.request.GroupAddReq;
import com.joker2yue.chat.common.chat.domain.vo.request.member.MemberAddReq;
import com.joker2yue.chat.common.chat.domain.vo.request.member.MemberDelReq;
import com.joker2yue.chat.common.chat.domain.vo.request.member.MemberReq;
import com.joker2yue.chat.common.chat.domain.vo.response.ChatMemberListResp;
import com.joker2yue.chat.common.chat.domain.vo.response.ChatRoomResp;
import com.joker2yue.chat.common.chat.domain.vo.response.MemberResp;
import com.joker2yue.chat.common.chat.service.ChatService;
import com.joker2yue.chat.common.chat.service.RoomAppService;
import com.joker2yue.chat.common.chat.service.RoomService;
import com.joker2yue.chat.common.chat.service.adapter.ChatAdapter;
import com.joker2yue.chat.common.chat.service.adapter.MemberAdapter;
import com.joker2yue.chat.common.chat.service.adapter.RoomAdapter;
import com.joker2yue.chat.common.chat.service.cache.*;
import com.joker2yue.chat.common.chat.service.strategy.msg.AbstractMsgHandler;
import com.joker2yue.chat.common.chat.service.strategy.msg.MsgHandlerFactory;
import com.joker2yue.chat.common.common.annotation.RedissonLock;
import com.joker2yue.chat.common.common.domain.vo.request.CursorPageBaseReq;
import com.joker2yue.chat.common.common.domain.vo.response.CursorPageBaseResp;
import com.joker2yue.chat.common.common.event.GroupMemberAddEvent;
import com.joker2yue.chat.common.common.exception.GroupErrorEnum;
import com.joker2yue.chat.common.common.utils.AssertUtil;
import com.joker2yue.chat.common.user.dao.UserDao;
import com.joker2yue.chat.common.user.domain.entity.User;
import com.joker2yue.chat.common.user.domain.enums.RoleEnum;
import com.joker2yue.chat.common.user.domain.enums.WSBaseResp;
import com.joker2yue.chat.common.user.domain.vo.response.ws.ChatMemberResp;
import com.joker2yue.chat.common.user.domain.vo.response.ws.WSMemberChange;
import com.joker2yue.chat.common.user.service.IRoleService;
import com.joker2yue.chat.common.user.service.cache.UserCache;
import com.joker2yue.chat.common.user.service.cache.UserInfoCache;

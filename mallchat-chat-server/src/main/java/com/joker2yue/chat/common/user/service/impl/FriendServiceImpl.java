...
import com.joker2yue.chat.common.chat.domain.entity.RoomFriend;
...
import com.joker2yue.chat.common.common.domain.vo.request.PageBaseReq;
import com.joker2yue.chat.common.common.domain.vo.response.CursorPageBaseResp;
import com.joker2yue.chat.common.common.domain.vo.response.PageBaseResp;
...
import com.joker2yue.chat.common.user.dao.UserFriendDao;
import com.joker2yue.chat.common.user.domain.entity.User;
import com.joker2yue.chat.common.user.domain.entity.UserApply;
import com.joker2yue.chat.common.user.domain.entity.UserFriend;
import com.joker2yue.chat.common.user.domain.vo.request.friend.FriendApplyReq;
import com.joker2yue.chat.common.user.domain.vo.request.friend.FriendApproveReq;
import com.joker2yue.chat.common.user.domain.vo.request.friend.FriendCheckReq;
import com.joker2yue.chat.common.user.domain.vo.response.friend.FriendApplyResp;
import com.joker2yue.chat.common.user.domain.vo.response.friend.FriendCheckResp;
import com.joker2yue.chat.common.user.domain.vo.response.friend.FriendResp;
import com.joker2yue.chat.common.user.domain.vo.response.friend.FriendUnreadResp;
import com.joker2yue.chat.common.user.service.FriendService;
import com.joker2yue.chat.common.user.service.adapter.FriendAdapter;
...
import static com.joker2yue.chat.common.user.domain.enums.ApplyStatusEnum.WAIT_APPROVAL;

...
import com.joker2yue.chat.common.common.event.UserBlackEvent;
import com.joker2yue.chat.common.common.event.UserRegisterEvent;
...
import com.joker2yue.chat.common.user.dao.BlackDao;
import com.joker2yue.chat.common.user.dao.ItemConfigDao;
import com.joker2yue.chat.common.user.dao.UserBackpackDao;
import com.joker2yue.chat.common.user.dao.UserDao;
import com.joker2yue.chat.common.user.domain.dto.ItemInfoDTO;
import com.joker2yue.chat.common.user.domain.dto.SummeryInfoDTO;
import com.joker2yue.chat.common.user.domain.entity.Black;
import com.joker2yue.chat.common.user.domain.entity.ItemConfig;
import com.joker2yue.chat.common.user.domain.entity.User;
import com.joker2yue.chat.common.user.domain.entity.UserBackpack;
import com.joker2yue.chat.common.user.domain.enums.BlackTypeEnum;
import com.joker2yue.chat.common.user.domain.enums.ItemEnum;
import com.joker2yue.chat.common.user.domain.enums.ItemTypeEnum;
import com.joker2yue.chat.common.user.domain.vo.request.user.*;
import com.joker2yue.chat.common.user.domain.vo.response.user.BadgeResp;
import com.joker2yue.chat.common.user.domain.vo.response.user.UserInfoResp;
import com.joker2yue.chat.common.user.service.UserService;
import com.joker2yue.chat.common.user.service.adapter.UserAdapter;
import com.joker2yue.chat.common.user.service.cache.ItemCache;
import com.joker2yue.chat.common.user.service.cache.UserCache;
import com.joker2yue.chat.common.user.service.cache.UserSummaryCache;

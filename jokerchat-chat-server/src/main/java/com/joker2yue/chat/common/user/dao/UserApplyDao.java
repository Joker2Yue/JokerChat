package com.joker2yue.chat.common.user.dao;

import com.joker2yue.chat.common.user.domain.entity.UserApply;
import com.joker2yue.chat.common.user.domain.enums.ApplyStatusEnum;
import com.joker2yue.chat.common.user.domain.enums.ApplyTypeEnum;
import com.joker2yue.chat.common.user.mapper.UserApplyMapper;
...
import static com.joker2yue.chat.common.user.domain.enums.ApplyReadStatusEnum.READ;
import static com.joker2yue.chat.common.user.domain.enums.ApplyReadStatusEnum.UNREAD;
import static com.joker2yue.chat.common.user.domain.enums.ApplyStatusEnum.AGREE;

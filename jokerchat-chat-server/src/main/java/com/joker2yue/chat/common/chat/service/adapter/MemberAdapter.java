package com.joker2yue.chat.common.chat.service.adapter;
...
import com.joker2yue.chat.common.user.domain.enums.WSRespTypeEnum;
...
import static com.joker2yue.chat.common.user.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_ADD;
import static com.joker2yue.chat.common.user.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_REMOVE;
